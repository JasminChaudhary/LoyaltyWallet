import 'dart:io';
import 'package:LoyaltyWallet/add_barcode.dart';
import 'package:LoyaltyWallet/alert_box.dart';
...
import 'package:LoyaltyWallet/store_modal.dart';
...
class ScanModal {
  ...
  static InputImage? _inputImageFromCameraImage(
    ...
    if (kIsWeb) {
      // Web platform may not support camera in the same way
      if (dev) print('Web platform not fully supported for camera rotation');
    ...
    if (format == null ||
        (!kIsWeb && Platform.isAndroid && format != InputImageFormat.yuv_420_888) ||
