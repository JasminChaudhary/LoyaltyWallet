...
import 'package:LoyaltyWallet/models/fidelity_card.dart';
import 'package:LoyaltyWallet/utils/internet.dart';
...
class FidelityCardsProvider with ChangeNotifier {
  ...
  addCardAttachCustomStore(String storeName, String imageURL) async {
    // Use 'custom' as the storeID to mark this as a custom store
    addCard.storeID = 'custom';
    // Store custom store details 
    customStoreName = storeName;
    customStoreImageURL = imageURL;
    notifyListeners();
  }
